		...
		<div className={styles.clubProgram}>
			<div className={styles.wrapper}>
				...
				<p className={styles.description}>
					...
					программу, позволяющую существенно экономить средства и время на
					покупку бадминтонного инвентаря. Просто занимайтесь бадминтоном!
					Теперь не надо ездить за каждой тубой с воланами, за каждой обмоткой.
					Li-Ning Center предлагает полностью оснастить и экипировать ваш клуб.
					Начните сотрудничество с заключения договора на предоставление
					инвентаря и расходных материалов.
				</p>
				<h5 className={styles.advantages}>
					Особенности программы от Li-Ning Center:
				</h5>
				<ul className={styles.advantagesList}>
					<li className={styles.list}>Отсрочка платежа от 1 до 3х месяцев.</li>
					<li className={styles.list}>Оптовые цены.</li>
					<li className={styles.list}>
						Специальные условия для тренеров, инструкторов и организаторов
						соревнований.
					</li>
				...
				<span className={styles.contactUs}>
					...
					<span className={styles.green}>info@lining.center </span> <br />и наши
					менеджеры с удовольствием расскажут вам о нашей клубной программе.
				</span>
			</div>
			<img src={image} className={styles.image} alt='game'></img>
		</div>
	)
}
